          ...
          <div>
            ...
            <ul className="space-y-4">
              <li className="flex items-start">
                <MapPin className="mr-3 text-guiitar-accent mt-1" size={28} />
              ...
              <li className="flex items-center">
                ...
                <a href="tel:+91 93132 62712" className="text-gray-300 hover:text-guiitar-accent transition-colors">
                  +91 93132 62712
                </a>
              </li>
              <li className="flex items-center">
                <Mail className="mr-3 text-guiitar-accent" size={18} />
                <a href="mailto:guiitar@gsfcuniversity.ac.in" className="text-gray-300 hover:text-guiitar-accent transition-colors">
